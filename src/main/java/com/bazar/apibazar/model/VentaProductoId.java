...
/*Esta clase va a representar la clave primaria compuesta de nuestra tabla intermedia, por esto, debe usarse la
...
public class VentaProductoId implements Serializable{
    ...
    /*Como es compuesta, necesita tener referencias a las dos claves primarias de las entidades relacionadas,
    ...
    por Jpa-Hibernate para que no haya una clave compuesta repetida en la Entidad intermedia VentaProducto*/
    ...
    public boolean equals(Object o){
        ...
        //Cast del objeto genérico tipo Objects a objto de VentaProductoId
