...
public class VentaSimpleDto {
    ...
    public VentaSimpleDto(Long idVenta, LocalDate fechaVenta, Double totalVenta, Integer cantidadTotalProductos, List<ProductoDeVentaDto> listProductos, ClienteSimpleDto cliente) {
